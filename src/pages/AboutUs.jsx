      ...
      <div className="section aximo-section-padding6">
        <div className="container">
          <div className="aximo-section-title center title-description">
            ...
            <p>
              Our story started simply: just a person and an Android phone. But
              then, that one person became two, two became four, then eight, and
              we are still on that path of natural growth today.We ran on pure
              passion and were thrilled to see our clients succeed.{" "}
            </p>
            <p>
              ...
              long line of happy clients and successful campaigns. It just goes
              to show that something truly big can come from a very modest,
              humble beginning.
            </p>
            <p>
          ...
          <div className="row">
            <div className="col-lg-8">
              ...
              >
                <img
                  src="/assets/images/team/group-photo/_MG_4886.jpg"
                  sizes="(max-width: 991px) 100vw, 66vw"
                  width="5000"
                  height="4000"
                  loading="lazy"
                  alt="Marv Media creative team collaborating"
                />
              </div>
            </div>
            <div className="col-lg-4">
              <div
                className="aximo-story-thumb story-side-portrait wow fadeInUpX"
                data-wow-delay="0.2s"
              >
                <img
                  src="/assets/images/team/group-photo/_MG_5044.jpg"
                  sizes="(max-width: 991px) 100vw, 33vw"
                  width="3166"
                  height="3957"
                  loading="lazy"
                  alt="Marv Media team members wearing branded shirts"
                />
              </div>
              <div
                className="aximo-story-thumb story-side-portrait wow fadeInUpX"
              ...
              >
                <img
                  ...
                  height="5000"
                  loading="lazy"
                  alt="Marv Media team members collaborating with a tablet"
                />
              </div>
            </div>
            <div className="col-lg-4">
              ...
              >
                <img
                  src="/assets/images/team/group-photo/_MG_5094.jpg"
                  sizes="(max-width: 991px) 100vw, 33vw"
                  width="6000"
                  height="4000"
                  loading="lazy"
                  alt="Marv Media team strategy session"
                />
              </div>
              <div
                className="aximo-story-thumb wow fadeInUpX"
              ...
              >
                <img
                  src="/assets/images/team/group-photo/_MG_5086.jpg"
                  sizes="(max-width: 991px) 100vw, 33vw"
                  width="6000"
                  height="4000"
                  loading="lazy"
                  alt="Marv Media team working together"
                />
              </div>
            </div>
            <div className="col-lg-8">
              ...
              >
                <img
                  src="/assets/images/team/group-photo/_MG_5121.jpg"
                  sizes="(max-width: 991px) 100vw, 66vw"
                  width="6000"
                  height="4000"
                  loading="lazy"
                  alt="Marv Media team portrait"
                />
              </div>
            </div>
          </div>

          {/* Existing team gallery retained for reference.
          <div className="row">
            <div className="col-lg-8">
              <div
                className="aximo-story-thumb wow fadeInUpX"
        ...
        <div className="container">
          <div className="aximo-section-title center">
            ...
            <p className="mt-4">
              ...
              open communication, and excellence in execution. Each team member
              brings expertise and energy to every project, ensuring the{" "}
              <em>Marv Effect</em> is felt in every deliverable.
            </p>
          </div>
          <div className="row">
            {/* Team members */}
            {[
              ...
              {
                name: "Bukunmi",
                role: "Content Production Executive",
                img: "Bukunmi.jpg",
                width: 800,
                height: 1200,
              },
