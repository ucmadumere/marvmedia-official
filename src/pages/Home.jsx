            ...
            <div className="row">
              <div className="col-lg-8">
                <div className="aximo-hero-content">
                  ...
                  <p>
                    We are a creative agency helping African entrepreneurs,
                    thought leaders, and creatives communicate with clarity,
                ...
                <div className="col-lg-6">
                  ...
                  >
                    ...
                    <div className="aximo-iconbox-data">
                      ...
                      <p>
                        We help you show up consistently with platform-tailored
                        content, strategy, and community engagement that builds
                        real connection.
                      </p>
                ...
                <div className="col-lg-6">
                  ...
                  >
                    ...
                    <div className="aximo-iconbox-data">
                      ...
                      <p>
                        From reels to campaigns and events, we produce
                        scroll-stopping videos and visuals that tell your brand
                        story.
                      </p>
                      {/* <Link className="aximo-icon" to="/service">
                                            <img src="/assets/images/icon/arrow-right.svg" alt="" />
                ...
                <div className="col-lg-6">
                  ...
                  >
                    ...
                    <div className="aximo-iconbox-data">
                      ...
                      <p>
                        We craft creative brand identities and smart strategies
                        that position you to stand out, sell more, and scale
                        with purpose.
                      </p>
                      {/* <Link className="aximo-icon" to="/service">
                                            <img src="/assets/images/icon/arrow-right.svg" alt="" />
                ...
                <div className="col-lg-6">
                  ...
                  >
                    ...
                    <div className="aximo-iconbox-data">
                      ...
                      <p>
                        We design sleek websites and automate systems to help
                        your brand run smoother, faster, and smarter online.
                      </p>
                      {/* <Link className="aximo-icon" to="/service">
                                            <img src="/assets/images/icon/arrow-right.svg" alt="" />
                                        </Link> */}
